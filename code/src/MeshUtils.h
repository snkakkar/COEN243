...
# define SERVER_MIN_TIME    30 * 1000       // Minimum number of milliseconds server must receive messages to put all nodes to sleep
...
# define RECORD_DELTA       SLEEP_TIME / 1000 / 2 // The amount of time between sensor readings for us to record
